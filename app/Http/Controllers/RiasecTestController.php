...
class RiasecTestController extends Controller
{
    ...
    {
        $majors = [
            'RI' => 'Teknik Elektro, Teknik Industri, Teknik Komputer - ITB, UI, ITS',
            'RA' => 'Arsitektur, Desain Komunikasi Visual, Desain Interior - ITB, Telkom, Binus',
            'RS' => 'Ilmu Kesehatan, Ilmu Lingkungan, Ilmu Kehutanan - UI, UGM, UNAIR',
            'RE' => 'Manajemen, Teknik Sipil, Teknik Industri - UI, ITB, ITS',
            'RC' => 'Teknik Sipil, Aktuaria, Sistem Informasi - UI, Telkom',
            'IR' => 'Teknik Sipil, Teknik Mesin, Teknik Elektro - ITB, UI, ITS',
            'IA' => 'Ilmu Sejarah, Sastra, Ilmu Filsafat - UI, UGM, UPI',
            'IS' => 'Psikologi, Sosiologi, Ilmu Komunikasi - UI, UPI, UGM',
            'IE' => 'Ekonomi, Aktuaria, Ilmu Komputer - UI, ITB, UGM',
            'IC' => 'Aktuaria, Ilmu Komputer, Sistem Informasi - ITB, Binus, UI',
            'AR' => 'Desain Interior, Desain Komunikasi Visual, Arsitektur - UI, Binus',
            'AI' => 'Arkeologi, Ilmu Sejarah, Sastra - UI, UGM, UNUD',
            'AS' => 'Sosiologi, Jurnalisme, Pendidikan Seni - UPI, UNDIP, UI',
            'AE' => 'Desain Interior, Desain Komunikasi Visual, Management - UI, Binus',
            'AC' => 'Arsiparis, Pengelolaan Dokumen, Penulisan Kreatif - UI, UGM, UPI',
            'SR' => 'Pendidikan Jasmani, Kesehatan Masyarakat - UNJ, UNY, UNESA',
            'SI' => 'Psikologi, Sosiologi, Kesehatan Masyarakat - UI, UNAIR, UNJ',
            'SA' => 'Pendidikan Seni Musik, Sastra, Ilmu Komunikasi - UI, UPI, UGM',
            'SE' => 'Ilmu Komunikasi, Hubungan Internasional, Marketing - UI, Binus, UNAIR',
            'SC' => 'Ilmu Administrasi, Ilmu Kesejahteraan Sosial - UI, UGM, UNAIR',
            'ER' => 'Manajement, Bisnis, Teknik Industri - UI, UGM, ITB',
            'EI' => 'Ekonomi, Aktuaria, Manajement - UI, UNAIR, UGM',
            'EA' => 'Manajement, Hubungan Internasional, Marketing - UI, Binus, UGM',
            'ES' => 'Manajemen, Marketing, Hubungan Internasional - UI, Binus, UGM',
            'EC' => 'Akuntansi, Manajement, Bisnis - UI, Binus, UGM',
            'CR' => 'Teknik Sipil, Sistem Informasi, Ilmu Komputer - Binus, ITB, UI',
            'CI' => 'Aktuaria, Ilmu Komputer, Statistika - UI, UNUD',
            'CA' => 'Desain Interior, Desain Komunikasi Visual - Binus, ITB, UI',
            'CS' => 'Ilmu Perpustakaan, Ilmu Kesejahteraan Sosial - UI, UGM, UNAIR',
            'CE' => 'Akuntansi, Manajement, Ekonomi - UI, UGM, UNAIR',
        ];
